...
int SeqFileWriter::write(const char*key, size_t key_len, const char *value, size_t value_len)
{
    ...
    // std::cout << "b_record_len " << b_record_len << " record_len " << record_len << std::endl;
