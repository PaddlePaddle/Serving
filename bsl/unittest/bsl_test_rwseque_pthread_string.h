...
public:
    ...
    **/
    ...
    {
        MyParam<bsl::string> s;
        s.r.create();
        for (int i = 0; i < MAX_SIZE; ++i) s.data.push_back(rand_string()); 
        CREATE_PTHREAD(g_tid, bsl_rwseque_push<bsl::string>, 1, s);
        CREATE_PTHREAD(g_tid, bsl_rwseque_get<bsl::string>, 20, s);
    ...
    **/
    void test_push_pop_3()
    {
        ...
        CREATE_PTHREAD(g_tid, bsl_rwseque_push<bsl::string>, 10, s);
        CREATE_PTHREAD(g_tid, bsl_rwseque_get<bsl::string>, 20, s);
    ...
    **/
    void test_set_get_1()
    {
        ...
        s.r.assign(MAX_SIZE, "");
        s.default_value = "";
        CREATE_PTHREAD(g_tid, bsl_rwseque_set<bsl::string>, 1, s);
        CREATE_PTHREAD(g_tid, bsl_rwseque_get<bsl::string>, 20, s);
    ...
    **/
    void test_set_get_3()
    {
        ...
        s.r.assign(MAX_SIZE, "");
        s.default_value = "";
        CREATE_PTHREAD(g_tid, bsl_rwseque_set<bsl::string>, 10, s);
        CREATE_PTHREAD(g_tid, bsl_rwseque_get<bsl::string>, 20, s);
