...
- [Python Pipeline 核心功能](#python-pipeline-核心功能)
  - [安装与环境检查](#安装与环境检查)
  - [服务启动与关闭](#服务启动与关闭)
  - [本地与远程推理](#本地与远程推理)
  - [批量推理](#批量推理)
  - [单机多卡推理](#单机多卡推理)
  - [多种计算芯片上推理](#多种计算芯片上推理)
  - [TensorRT 推理加速](#tensorrt-推理加速)
  - [MKL-DNN 推理加速](#mkl-dnn-推理加速)
  - [低精度推理](#低精度推理)
  - [复杂图结构 DAG 跳过某个 Op 运行](#复杂图结构-dag-跳过某个-op-运行)
...
TensorRT 是一个高性能的深度学习推理优化器，在 Nvidia 的 GPU 硬件平台运行的推理框架，为深度学习应用提供低延迟、高吞吐率的部署推理。
